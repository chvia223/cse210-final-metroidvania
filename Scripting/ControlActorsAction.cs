...
namespace cse210_final_metroidvania.Scripting
{
    ...
    public class ControlActorsAction : Action
    {
        ...
        public ControlActorsAction(InputService inputService, PhysicsService physicsService, AudioService audioService)
        {
                ...
                if (hero.GetCanMove())
                {
                    ...
                    if (hero.GetStunTime() == 0)
                    {
                        ...
                        if (direction.GetY() == 1 && hero.CanJump())
                        {
                            ...
                            _audioService.PlaySound(Constants.SOUND_JUMP);
                        }
                    }
                    else
                    {
